...
if __name__ == '__main__':
    title = "自动化测试报告测试"
    file_path = "F:\\VScode\Pytest1\\result\\2f5c2f98-dafb-4d0e-a315-218263cea6c2-result.json"
    ...
    RECIPIENT = ["1148368634@qq.com","1967249757@qq.com","249048135@qq.com"]
    mail = Mail("1148368634@qq.com", "ilyrmzwfyhqaiccj", "smtp.qq.com")
    mail.send_mail(RECIPIENT, title, content, file_path)